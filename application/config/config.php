...
|
| If you intend to use and autoload the URL helper ONLY, use a URL like this:
|
| 'http://example.com/'
|
| You can set this to an empty string if you are using mod_rewrite.
|
*/
$config['base_url'] = 'http://localhost/algoritmos/'; // ¡Esta es la línea crítica corregida!
...
|--------------------------------------------------------------------------
|
| If you are using CodeIgniter without mod_rewrite (i.e. 'index.php' is
| still a part of your URLs), set this appropriately.
|
